		...
		<div id="list-problemReport" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="problemReport.user.label" default="User" /></th>
				...
				<g:each in="${problemReportInstanceList}" status="i" var="problemReportInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${problemReportInstance.id}">${fieldValue(bean: problemReportInstance, field: "user")}</g:link></td>
